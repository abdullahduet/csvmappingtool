...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary text-black pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center mb-4">
              <img 
                src={logo} 
                alt="CSV Mapping Tool Logo" 
                className="h-10 w-auto filter" 
              />
              <span style={{"color": "#2c5282"}} className="ml-2 text-xl font-bold">
               CSV Mapping Tool
              </span>
            </Link>
            <p className="text-sm mb-4 opacity-80 max-w-xs">
              Streamlined Solutions for Complex CSV Mapping and Transformation.
            </p>
        ...
        <div className="border-t border-white/20 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm opacity-70 mb-4 md:mb-0">
            © {currentYear} CSV Mapping Tool. All rights reserved.
          </p>
          <div className="flex space-x-6">
            <Link to="/changelog" className="text-sm opacity-70 hover:opacity-100 transition-opacity">
            Changelog
            </Link>
